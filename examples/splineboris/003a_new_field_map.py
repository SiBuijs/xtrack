...
# deg = 4 and field_tol = 1e-4 fits decapole, but neglects quadrupole and octupole components.
# Lower field_tol will also fit the noisy quadrupole and octupole components.
fitter = FieldFitter(

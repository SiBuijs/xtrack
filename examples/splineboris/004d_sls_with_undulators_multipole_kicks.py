"""
SLS simulation with undulators represented by Multipole kicks.

This script mirrors 004a_sls_with_undulators.py, but builds the undulator as
drift + thin-Multipole kicks sampled from the fitted field map.
"""
...
print("=" * 80)
print("SLS WITH MULTIPOLE-KICK UNDULATORS")
print("=" * 80)
print("Tunes:")

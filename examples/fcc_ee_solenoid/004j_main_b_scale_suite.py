...
def _resolve_coupling_correction(line, ip_name, k1s_knobs, comp_knobs=None):
    ...
    opt_coupling = line.match(
        ...
        vary=vary,
        targets=[
            xt.TargetSet(betx2=0, bety1=0, at=xt.START, tol=5e-8),
            xt.TargetSet(betx2=0, bety1=0, at=xt.END, tol=5e-8),
            xt.TargetSet(alfx2=0, alfy1=0, at=xt.START, tol=1e-9),
            xt.TargetSet(alfx2=0, alfy1=0, at=xt.END, tol=1e-9),

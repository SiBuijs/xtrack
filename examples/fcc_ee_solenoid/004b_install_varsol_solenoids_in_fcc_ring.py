...
_parser = argparse.ArgumentParser(
    description='Install VariableSolenoid solenoids and correctors in the FCC ring.')
...
# studies probe how sensitive the correction is to that balance. Mirrors the
# SplineBoris variant's comp_b_scale in 004b_install_solenoids_in_fcc_ring.py.

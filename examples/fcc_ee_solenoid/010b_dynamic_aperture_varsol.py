...
# Same non-local lattice and correction scheme as 010a, but with
# VariableSolenoid slices (from 004b_install_varsol_solenoids_in_fcc_ring.py
# and 004c_correct_solenoids_in_fcc_ring.py with SOLENOID_MODEL='varsol').
INPUT_LATTICE_JSON = (
...
_run_dynamic_aperture(
    ...
    title="VariableSolenoid: solenoids unpowered",
    with_progress=1,
)
plt.show()
